...
const FriendShow = () => {
  ...
  useEffect(() => {
    if (id) {
      axios.get(`http://192.168.0.207:3001/api/v1/users/${id}`)
        .then(response => {
  ...
  useEffect(() => {
    if (currentUserId && id) {
      axios.get(`http://192.168.0.207:3001/api/v1/users/${currentUserId}/friendships/${id}`)
        .then(response => {
  ...
  const handleAddFriend = async () => {
    ...
    setLoading(true);
    try {
      await axios.post(`http://192.168.0.207:3001/api/v1/users/${currentUserId}/friendships`, {
